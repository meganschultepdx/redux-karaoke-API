...
export function fetchLyrics(title, artist, musicMatchId, localSongId, dispatch) {
  return fetch('http://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=' + musicMatchId + '&apikey=f3ac453719ca5698c7e72bd9de753ba1').then(
    response => response.json(),
    error => console.log('ERRORERRROEROERRROEROROEROEROO!', error)
  ).then(function(json) {
